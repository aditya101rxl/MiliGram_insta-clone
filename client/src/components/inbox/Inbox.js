...
export const Inbox = () => {
    ...
    const userList = ['aditya', 'mohan', 'sohan', 'rakesh', 'rahul', 'suman', 'mukesh', 'raiv', 'vivek', 'deeepak', 'chandan', 'ashutoah'];
        ...
        <Paper variant='outlined' style={{ background: 'none' }}>
            <Grid container spacing={0}>
                <Grid item xs={12} sm={4}>
                    ...
                    <Box component="div" style={{ height: '74vh', background: '#fff' }} overflow="auto">
                        {
                            userList.map(user => (
                                <UserList user={user} />
                            ))
